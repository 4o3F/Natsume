...
pub const fn to_dbus_name(code: ErrorCode) -> &'static str {
    match code {
        ...
        ErrorCode::SessionIneligible => "org.natsume.Error.SessionIneligible",
        ErrorCode::SessionAmbiguous => "org.natsume.Error.SessionAmbiguous",
        ErrorCode::SessionAgentDuplicate => "org.natsume.Error.SessionAgentDuplicate",
        ErrorCode::SessionAutostartShadowed => "org.natsume.Error.SessionAutostartShadowed",
        ErrorCode::SessionAgentMissing => "org.natsume.Error.SessionAgentMissing",
        ErrorCode::SessionDisplayUnavailable => "org.natsume.Error.SessionDisplayUnavailable",
        ErrorCode::SessionDisplayLost => "org.natsume.Error.SessionDisplayLost",
        ErrorCode::SessionUiPresentedUnfocused => "org.natsume.Error.SessionUiPresentedUnfocused",
        ErrorCode::SessionLockUnsupported => "org.natsume.Error.SessionLockUnsupported",
        ErrorCode::SessionUnlockUnsupported => "org.natsume.Error.SessionUnlockUnsupported",
