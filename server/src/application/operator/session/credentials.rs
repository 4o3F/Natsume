...
pub(in crate::application::operator) const SESSION_CREDENTIAL_LENGTH: usize = 32;
...
pub(crate) struct SessionCredential(
    pub(in crate::application::operator) Zeroizing<[u8; SESSION_CREDENTIAL_LENGTH]>,
);

impl SessionCredential {
    pub(in crate::application::operator) fn generate() -> Result<Self, OperatorError> {
    ...
    pub(in crate::application::operator) fn from_wire(
    ...
    pub(in crate::application::operator) fn sha256(&self) -> SessionCredentialHash {
        SessionCredentialHash(Zeroizing::new(Sha256::digest(self.0.as_slice()).into()))
    }
}

pub(crate) struct SessionCredentialHex(pub(in crate::application::operator) SecretString);
...
pub(crate) struct SessionCredentialHash(
    pub(in crate::application::operator) Zeroizing<[u8; SESSION_CREDENTIAL_HASH_LENGTH]>,
);
...
pub(in crate::application::operator) fn decode_lower_hex(
    value: &str,
