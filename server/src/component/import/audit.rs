    ...
    pub(crate) fn import_committed(
        ...
        Self {
            ...
            detail: AuditDetail::ImportCommitted {
                seats_added_count: facts.seats_added,
                seats_removed_count: facts.seats_removed,
                mappings_changed_count: facts.mappings_changed,
                binding_impact_count: facts.binding_impacts,
                credential_revision_advanced_count: facts.credentials_advanced,
            },
        }
    }
